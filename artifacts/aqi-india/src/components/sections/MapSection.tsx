...
function createCityIcon(color: string, aqi: number, pulse: boolean) {
  ...
  const pulseRing = pulse
    ? `<div style="
      ...
      <div style="
        ...
        border-radius:50%;
        background:${color}18;
        animation:pulseRing 1.8s ease-out infinite 0.5s;
        pointer-events:none;
      "></div>`
    : "";
  ...
  const html = `
    ...
    <div style="position:relative;width:${size + 32}px;height:${size + 32}px;display:flex;align-items:center;justify-content:center;">
      ${pulseRing}
      <div style="
        position:relative;
        ...
        box-shadow:0 4px 16px ${color}55,0 2px 4px rgba(0,0,0,0.2);
        ...
        z-index:2;
      ">
        <span style="color:white;font-weight:800;font-size:11px;line-height:1;">${aqi}</span>
        <span style="color:rgba(255,255,255,0.85);font-size:8px;font-weight:600;line-height:1;margin-top:1px;">AQI</span>
      </div>
    </div>`;
              ...
              >
                <Popup className="aqi-popup">
                  <div className="p-1 min-w-[140px]">
                    ...
                    <p className="text-sm font-semibold" style={{ color: city.color }}>
                      {city.status}
                    </p>
            ...
            <>
              <DialogHeader>
                <div className="flex items-center gap-3 mb-2">
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-lg flex-col"
              ...
              <div className="space-y-4 py-2">
                <div className="grid grid-cols-3 gap-3">
                  {[
                    ...
                    { label: "Ozone (O3)", value: selectedCity.o3, unit: "ppb" },
                  ].map((item) => (
                ...
                <div className="bg-primary/5 border border-primary/20 p-4 rounded-xl flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {selectedCity.prediction} based on current weather patterns and historical data.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-destructive/10 border border-destructive/20 p-4 rounded-xl flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-destructive/80 mt-1">
                        Everyone should avoid all outdoor exertion. Stay indoors and keep activity levels low.
                      </p>
                    </div>
                  </div>
                )}
