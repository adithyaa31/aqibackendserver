...
const MEMBERS = [
  {
    ...
    skills: ["FrameWork", "HTML,JS,CSS", "LOGIC"],
  },
  {
    name: "Aditiya",
    role: "Research",
    ...
    skills: ["Database", "System Integration", "API Development"],
  },
  {
    name: "Amulya",
    role: "Data analysis",
    ...
    skills: ["Data Handling", "Statistics", "Comunication"],
  },
  {
    name: "Sinchana",
    role: "UI/UX",
